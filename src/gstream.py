...
class VideoOverlay:
    def __init__(self, rtsp_url):
        ...
        self.pipeline = Gst.parse_launch(f"""
            rtspsrc location={self.rtsp_url} latency=0 buffer-mode=auto ! queue ! decodebin ! videoconvert ! gdkpixbufoverlay name=overlay_time_date ! gdkpixbufoverlay name=overlay_lines ! autovideosink sync=false
        """)
...
if __name__ == "__main__":
    ...
    video_overlay = VideoOverlay(rtsp_url)
